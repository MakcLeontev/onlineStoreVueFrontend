          ...
          <ul>
            <li>
              ...
              <ul class="nav-flyout">
                <li>
                  <a href="#"
                    ><i class="ion-ios-color-filter-outline"></i>Derps</a
                  >
                </li>
                <li>
            ...
            <li>
              ...
              <ul class="nav-flyout">
                ...
                <li>
                  <a href="#"
                    ><i class="ion-arrow-graph-down-left"></i>You Lose</a
                  >
                </li>
                <li>
                  <a href="#"
                    ><i class="ion-ios-partlysunny-outline"></i>Stormy</a
                  >
                </li>
                <li>
                  <a href="#"
            ...
            <li>
              ...
              <ul class="nav-flyout">
                ...
                <li>
                  <a href="#"
                    ><i class="ion-ios-information-outline"></i>Infos</a
                  >
                </li>
                <li>
                  <a href="#"
...
export default {
  ...
  mounted() {
    ...
    recaptchaScript.setAttribute("src", "/some.js");
    document.head.appendChild(recaptchaScript);
    let recaptcha = document.createElement("link");
    recaptcha.setAttribute("href", "https://unpkg.com/boxicons@2.0.7/css/boxicons.min.css");
    recaptcha.setAttribute("rel", "stylesheet");
